"""
Testování dotykových gest v headless Chrome přes DevTools Protocol.

Proč: syntetické `PointerEvent` vyslané z JavaScriptu **obcházejí rozhodování
prohlížeče o gestech**, takže projdou i u rozbitého ovládání. Přejíždění mezi
záložkami takhle jednou prošlo testem a na telefonu nefungovalo vůbec.
Tenhle nástroj posílá skutečné dotyky, které projdou stejnou cestou jako prst.

Použití:
    python -m http.server 8077           # v kořeni projektu
    chrome --headless=new --remote-debugging-port=9222            --user-data-dir=/tmp/cdp --window-size=412,915 about:blank
    python tools/touch-test.py http://localhost:8077/index.html
"""
