...
export const cs = {
  ...
  'alarm.trendHint': 'Úroveň drží čáru, takže se mění s časem. Alarm platí jen do konce čáry, tedy do {date}.',
  'alarm.trendEnded': 'Čára doběhla, takže se alarm sám vypnul. Posuň ho, nebo nakresli novou.',
  'alarm.condition': 'Podmínka',
  'alarm.crossAny': 'Protnutí',
  'alarm.crossUp': 'Protnutí nahoru',
  'alarm.crossDown': 'Protnutí dolů',
  'alarm.trigger': 'Spouštění',
  'alarm.onlyOnce': 'Jen jednou',
  'alarm.everyTime': 'Pokaždé',
  'alarm.expiration': 'Platnost',
  'alarm.noExpiry': 'Bez omezení',
  'alarm.day1': '1 den',
  'alarm.day7': '1 týden',
  'alarm.day30': '30 dní',
  'alarm.message': 'Zpráva',
  'alarm.messagePlaceholder': 'Nepovinná, ukáže se při zaznění',
  'alarm.alerting': 'Upozornit',
  'alarm.fromEntry': 'od vstupu',
  'alarm.fromPrice': 'od ceny',
  'alarm.sound': 'Zvuk',
  'alarm.vibrate': 'Vibrace',
  'alarm.active': 'Zapnutý',
  'alarm.save': 'Uložit alarm',
  'alarm.delete': 'Smazat',
  'alarm.needPrice': 'Nejdřív zadej cenu větší než nula.',
